...
def KnightsTour(N, start_pos, closed_loop, printtext=None):
    ...
    def gen_possible_moves(current_position):
        possible_moves = []
        move_set = [(1, 2), (1, -2), (-1, 2), (-1, -2), (2, 1), (2, -1),
                    (-2, 1), (-2, -1)]  # Moves of knight
