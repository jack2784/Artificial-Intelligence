...
speed_deviation['slow'] = fuzz.trimf(speed_deviation.universe,
                                     [-10000000, -10, 0])
speed_deviation['right'] = fuzz.trimf(speed_deviation.universe, [-2, 0, 2])
speed_deviation['fast'] = fuzz.trimf(speed_deviation.universe,
                                     [0, 10, 10000000])

distance_from_car['close'] = fuzz.trimf(distance_from_car.universe,
                                        [-10000000, 0, 29])
distance_from_car['right'] = fuzz.trimf(distance_from_car.universe,
                                        [28, 30, 33])
distance_from_car['far'] = fuzz.trimf(distance_from_car.universe,
                                      [32, 35, 10000000])
...
rule1 = ctrl.Rule(speed_deviation['fast'] & distance_from_car['close'],
                  throttle['break'])
rule2 = ctrl.Rule(speed_deviation['slow'] & distance_from_car['far'],
                  throttle['speed up'])
rule3 = ctrl.Rule(speed_deviation['slow'] & distance_from_car['close'],
                  throttle['break'])
rule4 = ctrl.Rule(speed_deviation['fast'] & distance_from_car['far'],
                  throttle['break'])
rule5 = ctrl.Rule(speed_deviation['right'] & distance_from_car['right'],
                  throttle['maintain'])
rule6 = ctrl.Rule(speed_deviation['right'] & distance_from_car['close'],
                  throttle['break'])
rule7 = ctrl.Rule(speed_deviation['slow'] & distance_from_car['right'],
                  throttle['maintain'])
rule8 = ctrl.Rule(speed_deviation['right'] & distance_from_car['far'],
                  throttle['maintain'])
rule9 = ctrl.Rule(speed_deviation['fast'] & distance_from_car['right'],
                  throttle['break'])

rule1.view()

throttle_ctrl = ctrl.ControlSystem(
